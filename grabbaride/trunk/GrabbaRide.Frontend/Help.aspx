...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <h3>
		...
		The details and pricing of the rides are up to the involved parties to discuss on. GrabbaRide does not get involved in the process of accepting/approving rides. This is to ensure the freedom and flexibility of user control.<br>
		<br><strong>To search for a ride:</strong><br><br>&nbsp;&nbsp;&nbsp; 1) Select time<br>&nbsp;&nbsp;&nbsp; 2) Select day(s)<br>&nbsp;&nbsp;&nbsp; 3) Specific journey, by selecting starting point and ending point, on Google map<br>
		<br>If any of the available rides match the search criteria, a list of the matching rides will be displayed for user to view. The user can then click on the ride “details” to view a more in depth description of the ride.
    ...
    <h3>
		...
		<strong>To create a ride:</strong><br><br> &nbsp;&nbsp;&nbsp; 1) Specify the journey, by selecting start and end points on a Google Map<br> &nbsp;&nbsp;&nbsp; 2) Select total number of seats available<br> &nbsp;&nbsp;&nbsp; 3) Select time and day(s) of ride(s)<br> &nbsp;&nbsp;&nbsp; 4) Select when listing should become available and how long should the advertisement run for<br>
    ...
    <h3>
		...
		and About.<br>
		<br><strong>The following are information available for the user to update:</strong> Email, First Name, Last Name, Occupation, Location 
		and About Me.<br>
		<br>In addition to displaying user details, there is also a feedback rating in the profile page. The feedback system is based on users rating each other, upon receiving/giving the ride(s) to other users. This social score assist users in making the decision, whether to accept/approve the ride or not, based on other users’ feedback ratings. This gives a sense of security and safety for all users, and gives them some ground on which to judge the safety of rides/passengers.<br>
    ...
    <h3>
    	...
    	<p class="style1" style="width: 817px">
        The registration page is for non-registered users to sign up for an account with GrabbaRide so they can enjoy the services we provide. Registration is open to all members of the public.<br><br> 
		<strong>To sign up for an account, the following details are required from the user:</strong><br><br>
		&nbsp;&nbsp;&nbsp;
    ...
    <p class="style1" style="width: 817px">
		...
		<strong>The three possible feedback ratings are:</strong><br><br> &nbsp;&nbsp;&nbsp; 
		1) :) 	Good <br> &nbsp;&nbsp;&nbsp; 
		2) :| 	Average<br> &nbsp;&nbsp;&nbsp; 3) :( 	Bad<br><br>
