...
namespace GrabbaRide.ObjectMappings
{
    ...
    partial void OnRideTypeChanged();
		...
		public Ride()
		{
			this._Ride2 = default(EntityRef<Ride>);
		...
		[Association(Name="Ride_Ride", Storage="_Ride2", ThisKey="RideID", IsUnique=true, IsForeignKey=false)]
		public Ride Ride2
		{
			get
			{
				return this._Ride2.Entity;
			}
			set
			{
				Ride previousValue = this._Ride2.Entity;
				if (((previousValue != value) 
							|| (this._Ride2.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Ride2.Entity = null;
						previousValue.Ride1 = null;
					}
					this._Ride2.Entity = value;
					if ((value != null))
					{
						value.Ride1 = this;
					}
					this.SendPropertyChanged("Ride2");
				}
			}
		}
		...
		[Association(Name="Ride_Ride", Storage="_Ride1", ThisKey="RideID", IsForeignKey=true)]
		public Ride Ride1
		{
			get
			{
