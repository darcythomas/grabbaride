...
namespace GrabbaRide.Database
{
    ...
    partial void OnDetailsChanged();
		...
		[Association(Name="Ride_FavouriteRide", Storage="_FavouriteRides", OtherKey="RideID")]
    ...
    partial void OnLocationChanged();
		...
		[Association(Name="User_FeedbackRating", Storage="_FeedbackRatingsPlaced", OtherKey="UserRaterID")]
		...
		[Association(Name="User_FeedbackRating1", Storage="_FeedbackRatingsReceived", OtherKey="UserRatedID")]
		...
		[Association(Name="User_FavouriteRide", Storage="_FavouriteRides", OtherKey="UserID")]
		public EntitySet<FavouriteRide> FavouriteRides
		{
			get
			{
    ...
    partial void OnRatingChanged();
		...
		[Association(Name="User_FeedbackRating", Storage="_UserRater", ThisKey="UserRaterID", IsForeignKey=true)]
		...
		[Association(Name="User_FeedbackRating1", Storage="_UserRated", ThisKey="UserRatedID", IsForeignKey=true)]
    ...
    partial void OnDateAddedChanged();
		...
		[Association(Name="Ride_FavouriteRide", Storage="_Ride", ThisKey="RideID", IsForeignKey=true)]
		public Ride Ride
		{
			get
			{
		...
		[Association(Name="User_FavouriteRide", Storage="_User", ThisKey="UserID", IsForeignKey=true)]
		public User User
		{
			get
			{
