...
namespace GrabbaRide.Database
{
    ...
    partial void OnIsSignedInChanging(bool value);
    partial void OnIsSignedInChanged();
		...
		public bool IsSignedIn
		{
			...
			set
			{
				...
				{
					this.OnIsSignedInChanging(value);
					this.SendPropertyChanging();
					this._IsSignedIn = value;
					this.SendPropertyChanged("IsSignedIn");
					this.OnIsSignedInChanged();
				}
			}
		}
