...
namespace GrabbaRide.Database
{
    ...
    partial void DeleteProfile(Profile instance);
		...
		public System.Data.Linq.Table<SignOn> SignOns
		{
			get
			{
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _SignOnID;
		
		private int _ProfileID;
		
		private EntitySet<Ride> _Rides;
		
		private EntityRef<SignOn> _SignOn;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnSignOnIDChanging(string value);
    partial void OnSignOnIDChanged();
    ...
    partial void OnProfileIDChanged();
		...
		public User()
		{
			...
			this._SignOn = default(EntityRef<SignOn>);
		...
		[Column(Storage="_SignOnID", CanBeNull=false)]
		public string SignOnID
		{
			get
			{
				return this._SignOnID;
			}
			set
			{
				if ((this._SignOnID != value))
				{
					if (this._SignOn.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnSignOnIDChanging(value);
					this.SendPropertyChanging();
					this._SignOnID = value;
					this.SendPropertyChanged("SignOnID");
					this.OnSignOnIDChanged();
				}
			}
		}
		
		[Column(Storage="_ProfileID")]
		...
		[Association(Name="SignOn_User", Storage="_SignOn", ThisKey="SignOnID", IsForeignKey=true)]
		public SignOn SignOn
		{
			get
			{
				return this._SignOn.Entity;
			}
			set
			{
				SignOn previousValue = this._SignOn.Entity;
				if (((previousValue != value) 
							|| (this._SignOn.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._SignOn.Entity = null;
						previousValue.Users.Remove(this);
					}
					this._SignOn.Entity = value;
					if ((value != null))
					{
						value.Users.Add(this);
						this._SignOnID = value.SignOnID;
					}
					else
					{
						this._SignOnID = default(string);
					}
		...
		[Association(Name="Profile_User", Storage="_Profile", ThisKey="ProfileID", IsForeignKey=true)]
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnOpenID_AccountChanging(bool value);
    partial void OnOpenID_AccountChanged();
    ...
    partial void OnPasswordChanged();
		...
		[Column(Storage="_OpenID_Account")]
		public bool OpenID_Account
		{
			get
			{
				return this._OpenID_Account;
			}
			set
			{
				if ((this._OpenID_Account != value))
				{
					this.OnOpenID_AccountChanging(value);
					this.SendPropertyChanging();
					this._OpenID_Account = value;
					this.SendPropertyChanged("OpenID_Account");
					this.OnOpenID_AccountChanged();
				}
			}
		}
		
		[Column(Storage="_OpenID")]
		...
		[Column(Storage="_SignOnID", CanBeNull=false, IsPrimaryKey=true)]
		public string SignOnID
		{
			get
			{
		...
		[Association(Name="SignOn_User", Storage="_Users", OtherKey="SignOnID")]
    ...
    partial void OnOccupationChanged();
		...
		[Column(Storage="_ProfileID", IsPrimaryKey=true)]
		public int ProfileID
		{
			get
			{
		...
		[Column(Storage="_DOB", CanBeNull=false)]
		public string DOB
		{
			get
			{
		...
		[Column(Storage="_Occupation", CanBeNull=false)]
		...
		[Association(Name="Profile_User", Storage="_Users", OtherKey="ProfileID")]
		public EntitySet<User> Users
		{
			get
			{
