...
<asp:Content id="Content2" runat="server" contentplaceholderid="MainContentPlaceHolder">
	<div id="otherinfo" style="float: left; width: 865px; " class="style10">
		<div class="style15">
			...
			</span></span><span class="style9">Create A Ride</span><br /><br />
		</div>
		...
		</span><br /></span><span class="style5"><span class="style6">3) Please select number of seats available:&nbsp;<br />
		</span></span><span class="style1"><span class="style5">
		<span class="style6">
		...
		<br /></span></span></span><br class="style7" /><span class="style5">
		<span class="style6">4) Please select starting 
		time:</span></span><br class="style7" /><span class="style5">
		<span class="style6">
		...
		<br /><br />5) Please select the day(s):<br /><br />
		...
		</span><br class="style6" /><span class="style6"><br /><br />
		<asp:Button ID="btnCreate" runat="server" OnClick="btnCreate_Click" Text="Create Ride"
            Width="112px" />
		</span><br class="style6" /><br class="style6" /><br class="style6" />
		<br class="style6" /><br class="style6" /><span class="style6">
		<asp:HiddenField ID="hfend" runat="server" />
		<asp:HiddenField ID="hfstart" runat="server" />
		</span></span></div>
	<span class="style5"><br class="style6" /></span>
</asp:Content>
