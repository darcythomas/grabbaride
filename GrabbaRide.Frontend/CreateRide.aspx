...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:FormView ID="CreateRideFormView" runat="server" DataKeyNames="RideID" DataSourceID="RidesLinqDataSource"
        ...
        <InsertItemTemplate>
            ...
            DepartureTime:
            <asp:Calendar ID="DepartureTimeCalendar" runat="server" OnSelectionChanged="DepartureTimeCalendar_SelectionChanged"
            ...
            <br />
            ArrivalTime:
            <asp:Calendar ID="ArrivalTimeCalendar" runat="server" BackColor="White" BorderColor="#3366CC"
            ...
            <br />
            <asp:HiddenField ID="CreationDateTextBox" runat="server" Value='<%# Bind("CreationDate") %>' />
            <br />
            FromLocation:
            ...
            <br />
            <asp:HiddenField ID="UserTextBox" runat="server" Value='<%# Bind("User") %>' />
            <br />
