...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div id="otherinfo" style="float: left; width: 275px; margin-left: 18px;">
        ...
        <br />
        </span><span class="style3"><span class="style4">1) Please select <b>start date</b> (the date that the ride will appear on the 
        website):</span></span><asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:Calendar ID="calstart" runat="server" BackColor="White" 
                    ...
                    ForeColor="Black" Height="220px" Width="270px" NextPrevFormat="FullMonth" 
                    TitleFormat="Month">
        ...
        <br />
        <span class="style1">2) Please select <b>end date</b> (the date the ride will be 
        taken off the website):</span><asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <asp:Calendar ID="calEnd" runat="server" BackColor="White" BorderColor="Black" 
                    ...
                    ForeColor="Black" Height="220px" Width="271px" NextPrevFormat="FullMonth" 
                    TitleFormat="Month">
                    <SelectedDayStyle BackColor="#CC3333" ForeColor="White" />
                    <SelectorStyle BackColor="#CCCCCC" Font-Bold="True" Font-Names="Verdana" 
                        Font-Size="8pt" ForeColor="#333333" Width="1%" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <span class="style1">4) Please select the <b>day(s)</b> the ride is available 
        for:</span><br />
